...
export let BackgroundBentonApartment: PIXI.Texture;
...
export let Credits: PIXI.Texture;
...
export function loadTexturesAsync()
{
    ...
    const BackgroundBentonApartmentPath = require("../../assets/images/background/benton apartment.png");
    loader.add(BackgroundBentonApartmentPath); 
    ...
    const BackgroundLivingRoomPath = require("../../assets/images/background/living room.png");
    loader.add(BackgroundLivingRoomPath); 
    ...
    const CharacterFaceAmusedNosePath = require("../../assets/images/character/face amused nose.png");
    loader.add(CharacterFaceAmusedNosePath); 
    ...
    const CharacterHeadBunPath = require("../../assets/images/character/head bun.png");
    loader.add(CharacterHeadBunPath); 
    ...
    const CreditsPath = require("../../assets/images/credits.png");
    loader.add(CreditsPath); 
    ...
    return new Promise<void>(resolve =>
    {
        loader.load((_, resources) => {
            ...
            BackgroundBentonApartment = resources[BackgroundBentonApartmentPath]?.texture as PIXI.Texture;
            ...
            Credits = resources[CreditsPath]?.texture as PIXI.Texture;
